...
extrn three@0:near
public var_c, var_b, intermedRes4, intermedRes5
.data         
...
.const	
	...
	head         db    "Лаб №7.Сапбиєв. Вираз №%d", 0;   
	headerror 	 db    "Помилка!Лаб №7.Сапбиєв. Вираз №%d",0
	text1error   db    "Від'ємний вираз під логарифмом", 0;
